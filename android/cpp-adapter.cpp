...
class OnnxruntimeReactNativeJsiModule
    : public jni::JavaClass<OnnxruntimeReactNativeJsiModule> {
public:
  static constexpr auto kJavaDescriptor =
      "Lcom/onnxruntimereactnativejsi/OnnxruntimeReactNativeJsiModule;";

  static void registerNatives() {
    javaClassStatic()->registerNatives(
        {makeNativeMethod("nativeInstall",
                          OnnxruntimeReactNativeJsiModule::nativeInstall),
         makeNativeMethod("nativeCleanup",
                          OnnxruntimeReactNativeJsiModule::nativeCleanup)});
  }
...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *) {
  return jni::initialize(
      vm, [] { OnnxruntimeReactNativeJsiModule::registerNatives(); });
}
